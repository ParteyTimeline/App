// Vendored, unmodified: Tinder/StateMachine 0.3.0, StateMachine.kt
// https://github.com/Tinder/StateMachine (Apache License 2.0)
//
// Checked in so this standalone test harness has no external dependency to
// fetch by hand before it can compile — production code depends on the same
// library version via JitPack (see android/app/build.gradle.kts), this copy
// exists only so `run.ps1` can compile against it without an Android/Gradle
// build.
package com.tinder
